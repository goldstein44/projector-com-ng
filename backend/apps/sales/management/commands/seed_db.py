...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        sales_products = [
            ...
            {
                "name": "Optoma HD146X (Tokunbo)",
                "slug": "optoma-hd146x-tokunbo",
                "brand": "Optoma",
                "model": "HD146X",
                "price": 110000.00,
                "lumens": 3600,
                ...
                "is_available": True,
                "stock": 4,
                "image": "images/optoma-hd146x-tokunbo.jpg",
                "description": "Pre-owned Optoma HD146X projector in great condition with excellent brightness and performance.",
                "condition": "tokunbo",
            },
        ]
